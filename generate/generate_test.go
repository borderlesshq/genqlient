...
import (
	...
	"github.com/borderlesshq/genqlient/internal/testutil"
	"gopkg.in/yaml.v2"
)
		...
		t.Run(sourceFilename, func(t *testing.T) {
			generated, err := Generate(&Config{
				...
				Bindings: map[string]*TypeBinding{
					"ID":       {Type: "github.com/borderlesshq/genqlient/internal/testutil.ID"},
					...
					"Pokemon": {
						Type:              "github.com/borderlesshq/genqlient/internal/testutil.Pokemon",
						ExpectExactFields: "{ species level }",
					},
					"PokemonInput": {Type: "github.com/borderlesshq/genqlient/internal/testutil.Pokemon"},
				},
...
func TestGenerateWithConfig(t *testing.T) {
	tests := []struct {
		...
		{"CustomContext", "", nil, &Config{
			Generated:   "generated.go",
			ContextType: "github.com/borderlesshq/genqlient/internal/testutil.MyContext",
		}},
		{"CustomContextWithAlias", "", nil, &Config{
			Generated:   "generated.go",
			ContextType: "github.com/borderlesshq/genqlient/internal/testutil/junk---fun.name.MyContext",
		}},
		...
		{"PackageBindings", "", nil, &Config{
			PackageBindings: []*PackageBinding{
				{Package: "github.com/borderlesshq/genqlient/internal/testutil"},
			},
		}},
		...
		{"ClientGetter", "", nil, &Config{
			Generated:    "generated.go",
			ClientGetter: "github.com/borderlesshq/genqlient/internal/testutil.GetClientFromContext",
		}},
		{"ClientGetterCustomContext", "", nil, &Config{
			Generated:    "generated.go",
			ClientGetter: "github.com/borderlesshq/genqlient/internal/testutil.GetClientFromMyContext",
			ContextType:  "github.com/borderlesshq/genqlient/internal/testutil.MyContext",
		}},
		{"ClientGetterNoContext", "", nil, &Config{
			Generated:    "generated.go",
			ClientGetter: "github.com/borderlesshq/genqlient/internal/testutil.GetClientFromNowhere",
			ContextType:  "-",
		}},
