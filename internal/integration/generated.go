...
func (v *AnimalFieldsOwnerUser) GetLuckyNumber() int64 { return v.LuckyFieldsUser.LuckyNumber }
...
func (v *InnerLuckyFieldsUser) GetLuckyNumber() int64 { return v.LuckyNumber }
...
func (v *LuckyFieldsUser) GetLuckyNumber() int64 { return v.LuckyNumber }
...
func (v *QueryFragmentBeingsUser) GetLuckyNumber() int64 { return v.InnerLuckyFieldsUser.LuckyNumber }
...
func (v *UserFields) GetLuckyNumber() int64 { return v.LuckyFieldsUser.LuckyNumber }
...
type queryWithFragmentsBeingsAnimal struct {
	...
	Id       string                                       `json:"id,omitempty"`
	Name     string                                       `json:"name,omitempty"`
	Hair     queryWithFragmentsBeingsAnimalHairBeingsHair `json:"hair,omitempty"`
...
func (v *queryWithFragmentsBeingsAnimalOwnerUser) GetLuckyNumber() int64 { return v.LuckyNumber }
...
type queryWithFragmentsBeingsUser struct {
	...
	Name        string                           `json:"name,omitempty"`
	LuckyNumber int64                            `json:"luckyNumber,omitempty"`
	Hair        queryWithFragmentsBeingsUserHair `json:"hair,omitempty"`
}
...
func (v *queryWithFragmentsBeingsUser) GetLuckyNumber() int64 { return v.LuckyNumber }
...
func (v *queryWithNamedFragmentsBeingsUser) GetLuckyNumber() int64 {
...
func (v *queryWithOmitemptyUser) GetLuckyNumber() int64 { return v.LuckyNumber }
...
func (v *queryWithVariablesUser) GetLuckyNumber() int64 { return v.LuckyNumber }
...
func (v *simpleQueryExtMeUser) GetLuckyNumber() int64 { return v.LuckyNumber }
...
func (v *simpleQueryMeUser) GetLuckyNumber() int64 { return v.LuckyNumber }
